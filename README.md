...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-clusters-plotter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15471&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-clusters-plotter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-clusters-plotter` can be installed with:

```
conda install napari-clusters-plotter
```

It is possible to list all of the versions of `napari-clusters-plotter` available on your platform with:
